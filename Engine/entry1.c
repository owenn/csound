...
OENTRY opcodlst_1[] = {
  ...
  */
  ...
  { "init", S(INIT_INSTANCE), 0,  ":Instr;", ":InstrDef;m", (SUBR) init_instance_opcode, NULL, NULL },
  ...
  { "instance.k", S(LINEVENT2),0,      ":Instr;",  "kkz",  NULL, instanceOpcode, NULL   },
  { "instance.S", S(LINEVENT2),0,   ":Instr;",  "Siim",  instanceOpcode_S, NULL, NULL},
  { "instance.kS", S(LINEVENT2),0,   ":Instr;",  "SSz",  NULL, instanceOpcode_S, NULL },
  ...
  { "delete",  S(DELETEIN), 0, "", ":InstrDef;",  NULL, NULL, (SUBR) delete_instr},
