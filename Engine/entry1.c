...
OENTRY opcodlst_1[] = {
 ...
 { "##mul.iC",  S(AOP),0,          ":Complex;",    "i:Complex;",
  ...
  /* Change these to
     { "oscil.kkk", S(POSC),TR,  "k", "kkjo", posc_set, kposc         },
     { "oscil.kka", S(POSC),TR, , "a", "kkjo"_set, NULL, posckk },
     { "oscil.ka", S(POSC),TR,  "a", "kajo", posc_set,  poscka },
     { "oscil.ak", S(POSC),TR,  "a", "akjo", posc_set,  poscak },
     { "oscil.aa", S(POSC),TR,  "a", "aajo", posc_set,  poscaa },
     { "oscil3.kk",  S(POSC),TR,  7, "s", "kkjo", posc_set, kposc posc3 },
  */
  ...
  { "in.A",   S(INA),0,            "a[]",  "",     NULL,   inarray },
  { "ins",    S(INS),0,            "aa",   "",     NULL,   ins     },
  { "inq",    S(INQ),0,            "aaaa", "",     NULL,   inq     },
  { "out.a",  S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "out.A",  S(OUTARRAY),IR,       "",     "a[]",  outarr_init,  outarr },
  { "outs",   S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "outq",   S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "outh",   S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "outo",   S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "outx",   S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "out32",  S(OUTX),IR,           "",     "y",    ochn,   outall },
  { "outs1",  S(OUTM),IR,           "",     "a",    NULL,   outs1   },
  { "outs2",  S(OUTM),IR,          "",     "a",    och2,   outs2   },
  { "outq1",  S(OUTM),IR,           "",     "a",    NULL,   outs1   },
  { "outq2",  S(OUTM),IR,          "",     "a",    och2,   outs2   },
  { "outq3",  S(OUTM),IR,          "",     "a",    och3,   outq3   },
  { "outq4",  S(OUTM),IR,          "",     "a",    och2,   outq4   },
  ...
  */
  ...
  { "schedule", S(SCHED),0,       "",     "iiim",
    schedule, NULL, NULL },
  { "schedule.Ninstr", S(SCHED),0,       "",     ":Instr;iiN",
  ...
  { "schedulek.instr",   S(SCHED),0,        "",     ":Instr;kkM",
    NULL, schedule, NULL },
  { "schedulek",   S(SCHED),0,        "",     "kkkM",  
    NULL, schedule, NULL },
  { "schedulek.Ninstr", S(SCHED),0,        "",     ":Instr;kkN",
  ...
  /* **** End of schedulek **** */
  { "schedwhen.instr", S(WSCHED),0,     "",  ":Instr;kkkm",ifschedule, kschedule, NULL },
  { "schedwhen", S(WSCHED),0,     "",     "kkkkm",ifschedule, kschedule, NULL },
  { "schedwhen", S(WSCHED),0,     "",     "kSkkm",ifschedule, kschedule, NULL },

  { "schedkwhen.instr", S(TRIGINSTR),0, "",     ":Instr;kkkkz",triginset, ktriginstr, NULL },  
  ...
  { "nstance", S(LINEVENT2),0,      "k",  ":Instr;kz",  NULL, instanceOpcode, NULL   },
  { "nstance", S(LINEVENT2),0,      "k",  "kkz",  NULL, instanceOpcode_Instr, NULL   },
  { "nstance.instr", S(LINEVENT2),0,   "i",  ":Instr;iim",  instanceOpcode_Instr, NULL, NULL  },
  ...
  { "turnoff2_i.instr",S(TURNOFF2),_CW,     "",  ":Instr;oo",  turnoff2Instr, NULL     },
  { "turnoff2_i.S",S(TURNOFF2),_CW,     "",     "Soo",  turnoff2S, NULL     },
  { "turnoff2_i.i",S(TURNOFF2),_CW,     "",     "ioo",  turnoff2k, NULL     },
  { "turnoff2.Instr",S(TURNOFF2),_CW,      "",     ":Instr;kk",  NULL, turnoff2Instr, NULL     },
  ...
  { "turnoff3.Instr",S(TURNOFF2),_CW,      "",     ":Instr;",  NULL, turnoff3Instr, NULL     },
