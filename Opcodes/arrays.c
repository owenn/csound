...
static OENTRY arrayvars_localops[] =
  {
    ...
    {"##rem.[i]",  sizeof(TABARITH), 0, "i[]", "i[]i[]", (SUBR)tabremi},
    ...
    {"##add.[p", sizeof(TABARITH1), 0, "i[]", "i[]i", (SUBR)tabaiaddi },
    {"##add.p[", sizeof(TABARITH2), 0, "i[]", "ii[]", (SUBR)tabiaaddi },
    ...
    {"##addin.[i", sizeof(TABARITHIN1), 0, "i[]", "i", (SUBR)addinAA, NULL },
    {"##addin.[k", sizeof(TABARITHIN1), 0, "k[]", "i", NULL, (SUBR)addinAA },
    {"##addin.[", sizeof(TABARITHIN), 0, "i[]", "i[]",  (SUBR)tabaddinkk, NULL },
    {"##addin.[K", sizeof(TABARITHIN), 0, "k[]", "k[]", NULL, (SUBR)tabaddinkk },
    {"##addin.[a", sizeof(TABARITHIN), 0, "a[]", "a[]", NULL, (SUBR)tabaaddin },
    {"##addin.[a", sizeof(TABARITHIN), 0, "a[]", "a[]", NULL, (SUBR)tabaaddin },
    {"##addin.[ak", sizeof(TABARITHIN), 0, "a[]", "k[]", NULL, (SUBR)tabarkrddin },
    {"##addin.[aks", sizeof(TABARITHIN), 0, "a[]", "k", NULL, (SUBR)tabakaddin },
    ...
    {"##subin.[i", sizeof(TABARITHIN1), 0, "i[]", "i", (SUBR)subinAA, NULL },
    {"##subin.[", sizeof(TABARITHIN), 0, "i[]", "i[]",  (SUBR)tabsubinkk, NULL },
    {"##subin.[K", sizeof(TABARITHIN), 0, "k[]", "k[]", NULL, (SUBR)tabsubinkk },
    {"##subin.[k", sizeof(TABARITHIN1), 0, "k[]", "k", NULL, (SUBR)subinAA },
    {"##subin.[a", sizeof(TABARITHIN), 0, "a[]", "a[]", NULL, (SUBR)tabaasubin },
    {"##subin.[ak", sizeof(TABARITHIN), 0, "a[]", "k[]", NULL, (SUBR)tabarkrsbin },
    {"##subdin.[aks", sizeof(TABARITHIN), 0, "a[]", "k", NULL, (SUBR)tabaksubin },
    {"##sub.[p", sizeof(TABARITH1), 0, "i[]", "i[]i", (SUBR)tabaisubi },
    {"##sub.p[", sizeof(TABARITH2), 0, "i[]", "ii[]", (SUBR)tabiasubi },
    ...
    {"##mul.[p", sizeof(TABARITH1), 0, "i[]", "i[]i", (SUBR)tabaimulti },
    {"##mul.p[", sizeof(TABARITH2), 0, "i[]", "ii[]",  (SUBR)tabiamulti },
    ...
    {"##div.[p",  sizeof(TABARITH1), 0, "i[]", "i[]i", (SUBR)tabaidivi },
    {"##div.p[",  sizeof(TABARITH2), 0, "i[]", "ii[]", (SUBR)tabiadivi },
    ...
    {"##rem.[p",  sizeof(TABARITH1),0,  "i[]", "i[]i", (SUBR)tabairemi },
    {"##rem.p[",  sizeof(TABARITH2),0,  "i[]", "ii[]", (SUBR)tabiaremi },
    ...
    {"##pow.[p",  sizeof(TABARITH1), 0, "i[]", "i[]i", (SUBR)tabaipowi },
    {"##pow.p[",  sizeof(TABARITH2), 0, "i[]", "ii[]", (SUBR)tabiapowi },
    ...
    { "maxarray.k", sizeof(TABQUERY), 0, "kz", "k[]",
      (SUBR) tabqset,(SUBR) tabmax },
    { "maxarray.i", sizeof(TABQUERY), 0, "iI", "i[]",(SUBR) tabmax1, NULL  },
    ...
    { "=._", sizeof(TABCPY), 0, ".[]", ".[]", (SUBR)tabcopy, (SUBR)tabcopy },
    ...
    /*  { "maparray.s", sizeof(TABMAP), 0, "S[]", "S[]S", (SUBR) tabmap_set, */
    /*                                               (SUBR) tabmap_perf     }, */
    ...
    { "copyf2array.kk", sizeof(TABCOPY), TR, "", "k[]kk",
      (SUBR) ftab2tabi, (SUBR) ftab2tab },
    // { "copya2ftab.i", sizeof(TABCOPY), TW, "", "i[]i", (SUBR) tab2ftabi },
    { "copya2ftab.ii", sizeof(TABCOPY2), TW, "", "i[]io", (SUBR) tab2ftab_offset_i },
    { "copya2ftab.kk", sizeof(TABCOPY2), TW, "", "k[]kO", NULL , (SUBR) tab2ftab_offset },
    ...
    { "taninv2.Ai", sizeof(TABARITH), 0, "i[]", "i[]i[]", (SUBR)taninv2_Ai  },
    { "taninv2.Ak", sizeof(TABARITH), 0, "k[]", "k[]k[]", (SUBR)tabarithset, (SUBR)taninv2_A  },
    { "taninv2.Aa", sizeof(TABARITH), 0, "a[]", "a[]a[]", (SUBR)tabarithset, (SUBR)taninv2_Aa  },
    { "autocorr", sizeof(AUTOCORR), 0, "k[]", "k[]", (SUBR) init_autocorr, (SUBR) perf_autocorr },
    { "clear", sizeof(TABCLEAR), 0, "", "a[]", (SUBR)tabclearset, (SUBR)tabclear  },
    { "clear", sizeof(TABCLEAR), 0, "", "k[]", (SUBR)tabclearset, (SUBR)tabcleark  }
  };
